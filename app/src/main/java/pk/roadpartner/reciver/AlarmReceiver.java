...
public class AlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void setAlarm(Context context) {
        ...
        // Enable {@code PhoneBootReceiver} to automatically restart the alarm when the
        // device is rebooted.
    ...
    public void cancelAlarm(Context context) {
        ...
        // Disable {@code PhoneBootReceiver} so that it doesn't automatically restart the
